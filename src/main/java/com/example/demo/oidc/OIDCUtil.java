...
//用戶端編號（CLIENT_ID）: xxxxx
//用戶端密鑰（CLIENT_SECRET）: xxxxx
//回調 Servlet 的 URI（REDIRECT_URI）: https://localhost:8443/callback/google
//google 網頁應用程式 的用戶端 ID
//https://console.cloud.google.com/apis/credentials/oauthclient/

public class OIDCUtil {
	private static final String CLIENT_ID = "xxxxx"; // 用戶端編號
	private static final String CLIENT_SECRET = "xxxxx"; // 用戶端密鑰
